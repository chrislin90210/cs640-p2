...
{	
	...
	public void handlePacket(Ethernet etherPacket, Iface inIface)
	{
		...
		int nextHopAddress = routeEntry.getGatewayAddress() == 0 ? routeEntry.getDestinationAddress() : routeEntry.getGatewayAddress();
		...
		// set destination MAC address of the ethernet packet to the looked up MAC address
		etherPacket.setDestinationMACAddress(arpEntry.getMac().toBytes());
		// set source MAC address of the ethernet packet to that of the outgoing interface
	 ...
	 * @param ByteBuffer the ByteBuffer containing serialized fields of the IP Header
